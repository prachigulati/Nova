...
// //   // Set default view to 'dashboard' instead of 'schedule'
...
// //     { 
// //       sender: 'bot', 
// //       text: "Hey Ava! I'm your live voice companion. Speak to me or type below, and I'll talk right back to you in real-time with a fast, friendly female voice!",
// //       timestamp: 'Just now'
// //     }
// //   ]);
...
// //         botReply = data.reply || "I'm listening, Ava! Tell me more.";
// //       } else {
...
// //           botReply = "You've got this, Ava! You're in the top 5% of your class with a 3.84 CGPA. Take a deep breath—you're fully prepared!";
// //         } else {
...
// //         />}
// //         {activeNav === 'profile' && <ProfileView passwordForm={passwordForm} setPasswordForm={setPasswordForm} handlePasswordChange={handlePasswordChange} />}
...
// export default function App() {
//   // Authentication State (Set to false so user starts on the login page)
...
export default function App() {
  ...
  const [chatMessages, setChatMessages] = useState([
    { 
      sender: 'bot', 
      text: "Hey! I'm your live voice companion. Speak to me or type below, and I'll talk right back to you in real-time with a fast, friendly female voice!",
      timestamp: 'Just now'
    }
  ]);
  const [chatInput, setChatInput] = useState('');
